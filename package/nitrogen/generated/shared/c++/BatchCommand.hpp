...
namespace margelo::nitro::rnduckdb {
  ...
  /**
   * A struct which can be represented as a JavaScript object (BatchCommand).
   */
...
namespace margelo::nitro {
  ...
  // C++ BatchCommand <> JS BatchCommand (object)
  template <>
  struct JSIConverter<margelo::nitro::rnduckdb::BatchCommand> final {
    static inline margelo::nitro::rnduckdb::BatchCommand fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
